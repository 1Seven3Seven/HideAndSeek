...
class ServerMessageInfo(BaseMessageInfo):
    ...
    CLIENT_CONNECTED_NOTIFICATION = 0x21, "I"
    CLIENT_DISCONNECTED_NOTIFICATION = 0x22, "I"
    # CLIENT_NAME_ACCEPTED = 0x23, ""
    # CLIENT_NAME_REJECTED = 0x24, ""
    # CLIENT_NEW_NAME_HEADER = 0x25, "II"
